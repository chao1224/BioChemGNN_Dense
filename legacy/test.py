...
# for enn
parser.add_argument('--enn_hidden_dim', type=int, default=16)
parser.add_argument('--enn_gru_layer_num', type=int, default=3)
...
if __name__ == '__main__':
    ...
    if args.model == 'ECFP':
        ...
        #     hidden_dim=args.enn_hidden_dim, gru_layer_num=args.enn_gru_layer_num,
        #     output_dim=args.task_num
        # )
        model = config_model[args.model]([dataset.node_feature_dim, dataset.edge_feature_dim+1], l_target=args.task_num)
    elif args.model == 'GIN':
        model = config_model[args.model](
            node_feature_dim=dataset.node_feature_dim,
