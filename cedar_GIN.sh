...
for task in "${task_list[@]}"; do
  ...
  for epochs in "${epochs_list[@]}"; do
    for learning_rate in "${learning_rate_list[@]}"; do
      for gin_epsilon in "${gin_epsilon_list[@]}"; do
          for gin_hidden_dim in "${gin_hidden_dim_list[@]}"; do
              ...
              for running_index in "${running_index_list[@]}"; do
                ...
                export task="$task"
                export gin_epsilon="$gin_epsilon"
                export gin_hidden_dim="$gin_hidden_dim"
